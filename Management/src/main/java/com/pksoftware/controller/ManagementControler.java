...
public class ManagementControler {
		...
		@GetMapping("/ikbalemployee")
		public List<IkbalHotel> getAllDataIkbalHotelEmployee(){
			   List<IkbalHotel> hotels = managementService.getAllDataOfIkbalHotelEmployee();
			   return hotels;
		}
		
		@GetMapping("/ikbalemployee/{id}")
		public IkbalHotel getByIdIkbalHotelEmployeeData(@PathVariable int id) {
			   IkbalHotel hotel = managementService.getByIdIkbalHotelEmployeeData(id);
			   return hotel;
		}
}

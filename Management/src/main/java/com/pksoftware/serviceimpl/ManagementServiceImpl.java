...
public class ManagementServiceImpl implements ManagementService{
	...
	public IkbalHotel insertIkbalHotelEmployeeData(IkbalHotel ikbalHotel) {
		IkbalHotel hotel = ikbalHotelService.insertIkbalHotelData(ikbalHotel);
		return hotel;
	}

	@Override
	public IkbalHotel updateIkbalHotelEmployeeData(IkbalHotel ikbalHotel) {
		IkbalHotel hotel = ikbalHotelService.updateIkbalHotelData(ikbalHotel);
		return hotel;
	}

	@Override
	public void deleteIkbalHotelEmployeeData(int id) {
		   ikbalHotelService.deleteIkbalHotelData(id);
	}

	@Override
	public List<IkbalHotel> getAllDataOfIkbalHotelEmployee() {
		List<IkbalHotel>  list = ikbalHotelService.getAllDataIkbalHotelEmployee();
		return list;
	}

	@Override
	public IkbalHotel getByIdIkbalHotelEmployeeData(int id) {
		IkbalHotel hotel = ikbalHotelService.getByIdIkbalHotelEmployee(id);
		return hotel;
	}
}
